  ...
  if Rails.env.development?
    ...
    provider :tumblr, 'JxCIF1tJaiqqJmiU4vdK7w0U4OwVuKGQfMgy8yib66b8Lwzma4', 'LScN6lBogvYkZKI80uWS5EfFtAElen3XncXXIrFux1kBmgT2Fy'
     ...
     provider :twitter, 'rN9LiKlovzzbSrWuL89aTw', 'PEs8uvscOfJtGVUSbMySiZtEnM7fF2bW9BPznRlE'
      provider :facebook, '3a210cc61ff613d5a2447572b20b0339', 'c70b54036fcb8db20e06b28dc504b61a', {:client_options => {:ssl => {:ca_path => "/etc/pki/tls/certs/ca-bundle.crt"}}, :scope => 'manage_pages'}  # Modify this with your SSL certificates path
